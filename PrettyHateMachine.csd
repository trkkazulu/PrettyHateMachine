...
image colour(255, 255, 255, 128), outlinethickness(4), bounds(0, 0, 700, 100), corners(5), file("brushed metal background 1305.jpg")
...
asig1 OctaveDivider a1, kdivider, kInputFilt, kToneFilt
